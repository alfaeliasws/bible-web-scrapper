...
CREATE TABLE `bible` (
  ...
  `bible_book` int DEFAULT NULL,
  `bible_chapter` int DEFAULT NULL
...
INSERT INTO `bible` VALUES ('current',66,21),('main',23,34),('old',5,13),('new',44,22);
...
-- Dump completed on 2022-11-03 17:08:31
