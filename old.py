...
bible_chapter_mysql = """SELECT bible_chapter, bible_book FROM bible where data = "old" """
...
update_mysql = f"""update bible set bible_book = {i}, bible_chapter = {bible_chapter_result} where data = "old" """
